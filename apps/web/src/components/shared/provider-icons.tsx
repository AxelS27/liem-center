/**
 * Monochrome OAuth provider marks. They use `currentColor` so they inherit the button's text
 * color and stay within the token system (no brand hex, no palette classes). Used by the sign-in
 * and sign-up provider buttons.
 */
